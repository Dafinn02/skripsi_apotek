        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body" style="background-color:#1166d8;">
              <form action="{{url('persediaan/stock_masuk')}}" id="form-option">
              <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label style="color: white">Tanggal kadaluarsa</label>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar data stock masuk</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @foreach($data as $key => $item)
                  <tr>  
                    ...
                    <td>{{ \Carbon\Carbon::make($item['kadaluarsa'])->format('d F Y')}}</td>
