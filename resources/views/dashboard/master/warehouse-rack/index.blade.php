  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row mb-2 d-flex justify-content-end mr-auto">
        <div class="ml-auto">
          <a class="btn btn-primary" href="{{url('/master/gudang')}}">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar data rack pada gudang {{$warehouse->name}}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @include('dashboard.master.warehouse-rack.modal-edit')
                  <tr>
                    <td>{{$key+1}}</td>
                    <td>{{$item->name}}</td>
                    <td>
    ...
    <!-- /.container-fluid -->
    @include('dashboard.master.warehouse-rack.modal-create')
  </section>
  <!-- /.content -->
</div>
<!-- /.content-wrapper -->
