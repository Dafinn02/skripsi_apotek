...
<div class="content-wrapper">
  ...
  <section class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar data unit</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @include('dashboard.master.unit.modal-edit')
                  <tr>  
                    <td>{{$key+1}}</td>
                    <td>{{$item->name}}</td>
                    <td>
                      ...
                      <a class="btn btn-danger btn-sm ondelete"
                         href="{{url('/master/produk/unit/delete/'.$item->id)}}">
    ...
    <!-- /.container-fluid -->
    @include('dashboard.master.unit.modal-create')
  </section>
  <!-- /.content -->
</div>
<!-- /.content-wrapper -->
