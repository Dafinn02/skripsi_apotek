...
<div class="content-wrapper">
  ...
  <section class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar data rak</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @include('dashboard.master.rack.modal-edit')
                  <tr>
                    <td>{{$key+1}}</td>
                    <td>{{$item->name}}</td>
                    <td>
                      ...
                      <a style="color: black;" class="btn btn-danger btn-sm"
                         href="{{url('/master/rak/delete/'.$item->id)}}" 
    ...
    <!-- /.container-fluid -->
    @include('dashboard.master.rack.modal-create')
  </section>
  <!-- /.content -->
</div>
<!-- /.content-wrapper -->
