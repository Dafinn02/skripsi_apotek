...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Daftar Rack Pada <b>{{$warehouse->name}}</b></h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row mb-2 d-flex justify-content-end mr-auto">
        <div class="ml-auto">
          <a class="btn btn-primary" href="{{url('warehouse')}}">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @include('dashboard.storage.rack.modal-edit')
                  <tr>
                    <td>{{$key+1}}</td>
                    <td>{{$item->name}}</td>
                    <td>
    ...
    <!-- /.container-fluid -->
    @include('dashboard.storage.rack.modal-create')
  </section>
  <!-- /.content -->
</div>
<!-- /.content-wrapper -->
