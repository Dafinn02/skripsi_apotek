...
<div class="content-wrapper">
  ...
  <section class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @include('dashboard.storage.warehouse.modal-edit')
                  <tr>
                    <td>{{$key+1}}</td>
                    <td>{{$item->name}}</td>
                    <td>
                      <a style="color: black;" class="btn btn-danger btn-sm"
                         href="{{url('warehouse/rack?warehouse_id='.$item->id)}}">
                    ...
                    <td>
                      ...
                      &nbsp;
                      <a style="color: black;" class="btn btn-danger btn-sm"
                         href="{{url('warehouse/delete/'.$item->id)}}" 
    ...
    <!-- /.container-fluid -->
    @include('dashboard.storage.warehouse.modal-create')
  </section>
  <!-- /.content -->
</div>
<!-- /.content-wrapper -->
