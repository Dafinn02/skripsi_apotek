                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                       <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="unit" placeholder="Strip" value="{{$data->unit}}">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                       <div class="form-group">
                        ...
                        <input required type="number" class="form-control" name="basic_price" placeholder="100000" value="{{$data->basic_price}}">
                      </div>
                    </div>
                    <div class="col-md-3">
                       <div class="form-group">
                        <label for="nama">Markup (%)</label>
                        <input required type="number" class="form-control" name="markup_percentage" placeholder="30" value="{{$data->markup_percentage}}">
                      </div>
                    </div>
                    <div class="col-md-3">
                       <div class="form-group">
                        ...
                        <select class="form-control" name="status" required>
                          ...
                          <option value="for_sale" {{$data->status == 'for_sale' ? 'selected' : ''}}>Dijual</option>
                          <option value="not_for_sale" {{$data->status == 'not_for_sale' ? 'selected' : ''}}>Tidak Dijual</option>
                        </select>
                      </div>
                    </div>
                  </div>
