...
<div class="content-wrapper">
  ...
  <section class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar data shift</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @include('dashboard.pengguna.shift.modal-edit')
                  <tr>  
                    <td>{{$key+1}}</td>
                    <td>{{$item->name}}</td>
                    ...
                    <td>
                      ...
                      <a style="color: black;" class="btn btn-danger btn-sm"
                         href="{{url('/pengguna/shift/delete/'.$item->id)}}" 
    ...
    <!-- /.container-fluid -->
    @include('dashboard.pengguna.shift.modal-create')
  </section>
  <!-- /.content -->
</div>
<!-- /.content-wrapper -->
